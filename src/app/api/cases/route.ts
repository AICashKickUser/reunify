  ...
  try {
    ...
    const newCase = await db.case.create({
      data: {
        ...
        removalDate: body.removalDate ? new Date(body.removalDate.slice(0, 10) + 'T12:00:00.000Z') : null,
        targetReunificationDate: body.targetReunificationDate ? new Date(body.targetReunificationDate.slice(0, 10) + 'T12:00:00.000Z') : null,
